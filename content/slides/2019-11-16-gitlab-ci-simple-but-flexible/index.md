...
The following build stage is based on the docs on gitlab, [Building a Docker
image with kaniko][gl_using_kaniko].
...
Next we will add a `test` stage, which will run unittests inside of this
container.
